...
logo_url_60="http://liveticker.bundesliga.de/global/gfx/emblem/dfl/60x60/"
logo_url_40="http://liveticker.bundesliga.de/global/gfx/emblem/dfl/40x40/"
...
--Anlegen der Verzeichnisse und Logos
function logos()
	ligawahl=1
...
--Pruefen ob Pluginverzeichnis existiert
...
function loadConfig()
	...
	conf["font_size"]  = config:getString("font_size",  "normal")
end
...
function saveConfig()
	if configChanged == 1 then
		...
		config:setString("font_size", conf["font_size"])
...
if tt == nil then
 ...
 td = tt:read("*a")
	...
	if j_table.ranking[zaehler].rank == "" then
	j_table.ranking[zaehler].rank = 1
	end
	
	if j_table.ranking[zaehler].last_rank == "" then
	j_table.ranking[zaehler].last_rank = 1
	end
...
function tickerfenster()
    ...
    w = cwindow.new{x=x, y=y, dx=dx, dy=dy, name="Bundesliga Liveticker" .. Pluginversion .. " - " .. ligawahl .. ". Bundesliga", icon=bllogo, has_shadow=true, btnRed="Einstellungen", btnGreen="Liveticker PIP", btnYellow="Blitztabelle", btnBlue=knop .. ". Bundesliga"}

    ctext.new{parent=w, x=250, y=5, dx=400, dy=60, text=matchday .. ". Spieltag", mode="ALIGN_AUTO_WIDTH | ALIGN_CENTER", font_text=FONT['MENU_TITLE']}
    
    ctext.new{parent=w, x=119, y=70  , dx=100, dy=60, text=lines[1], color_text=lines[10], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=399, y=70  , dx=100, dy=60, text=lines[2], color_text=lines[11], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=679, y=70  , dx=100, dy=60, text=lines[3], color_text=lines[12], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=119, y=170 , dx=100, dy=60, text=lines[4], color_text=lines[13], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=399, y=170 , dx=100, dy=60, text=lines[5], color_text=lines[14], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=679, y=170 , dx=100, dy=60, text=lines[6], color_text=lines[15], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=119, y=270 , dx=100, dy=60, text=lines[7], color_text=lines[16], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=399, y=270 , dx=100, dy=60, text=lines[8], color_text=lines[17], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    ctext.new{parent=w, x=679, y=270 , dx=100, dy=60, text=lines[9], color_text=lines[18], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
...
function tickertv()
    ...
    --Texte in oberer Reihe
    e[1]=ctext.new{x=xx+dxpic                                   , y=yy-120, dx=dxtxt, dy=dytxt, text=lines[1], color_body=hinterfarbe, color_text=lines[10], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[2]=ctext.new{x=xx+breite+zwischenraum+dxpic               , y=yy-120, dx=dxtxt, dy=dytxt, text=lines[2], color_body=hinterfarbe, color_text=lines[11], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[3]=ctext.new{x=xx+2*(breite+zwischenraum)+dxpic           , y=yy-120, dx=dxtxt, dy=dytxt, text=lines[3], color_body=hinterfarbe, color_text=lines[12], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[4]=ctext.new{x=xx+3*(breite+zwischenraum)+dxpic           , y=yy-120, dx=dxtxt, dy=dytxt, text=lines[4], color_body=hinterfarbe, color_text=lines[13], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[9]=ctext.new{x=xx+4*(breite+zwischenraum)+dxpic           , y=yy-120, dx=dxtxt, dy=dytxt, text=lines[9], color_body=hinterfarbe, color_text=lines[18], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    --Texte in unterer Reihe
    e[5]=ctext.new{x=xx+dxpic                                   , y=yy-60 , dx=dxtxt, dy=dytxt, text=lines[5], color_body=hinterfarbe, color_text=lines[14], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[6]=ctext.new{x=xx+breite+zwischenraum+dxpic               , y=yy-60 , dx=dxtxt, dy=dytxt, text=lines[6], color_body=hinterfarbe, color_text=lines[15], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[7]=ctext.new{x=xx+2*(breite+zwischenraum)+dxpic           , y=yy-60 , dx=dxtxt, dy=dytxt, text=lines[7], color_body=hinterfarbe, color_text=lines[16], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[8]=ctext.new{x=xx+3*(breite+zwischenraum)+dxpic           , y=yy-60 , dx=dxtxt, dy=dytxt, text=lines[8], color_body=hinterfarbe, color_text=lines[17], mode="ALIGN_CENTER", font_text=FONT[fontsize]}
    e[10]=ctext.new{x=xx+4*(breite+zwischenraum)+20             , y=yy-60 , dx=80   , dy=dytxt, text="zurÃ¼ck", color_body=0xFF, mode="ALIGN_LEFT"}
    e[11]=ctext.new{x=xx+4*(breite+zwischenraum)+dxpic+dxtxt+20 , y=yy-60 , dx=60   , dy=dytxt, text="BT", color_body=0xFF, mode="ALIGN_LEFT"}

    --Bilder in oberer Reihe
    p[1]=cpicture.new{x=xx                                      , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[1] .. ".png", transparency=2, color_background=0xFF}
    p[2]=cpicture.new{x=xx+dxpic+dxtxt                          , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[1] .. ".png", transparency=2, color_background=0xFF}
    p[3]=cpicture.new{x=xx+breite+zwischenraum                  , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[2] .. ".png", transparency=2, color_background=0xFF}
    p[4]=cpicture.new{x=xx+breite+zwischenraum+dxpic+dxtxt      , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[2] .. ".png", transparency=2, color_background=0xFF}
    p[5]=cpicture.new{x=xx+2*(breite+zwischenraum)              , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[3] .. ".png", transparency=2, color_background=0xFF}
    p[6]=cpicture.new{x=xx+2*(breite+zwischenraum)+dxpic+dxtxt  , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[3] .. ".png", transparency=2, color_background=0xFF}
    p[7]=cpicture.new{x=xx+3*(breite+zwischenraum)              , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[4] .. ".png", transparency=2, color_background=0xFF}
    p[8]=cpicture.new{x=xx+3*(breite+zwischenraum)+dxpic+dxtxt  , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[4] .. ".png", transparency=2, color_background=0xFF}
    p[17]=cpicture.new{x=xx+4*(breite+zwischenraum)             , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[9] .. ".png", transparency=2, color_background=0xFF}
    p[18]=cpicture.new{x=xx+4*(breite+zwischenraum)+dxpic+dxtxt , y=yy-120, dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[9] .. ".png", transparency=2, color_background=0xFF}
    --Bilder in unterer Reihe
    p[9]=cpicture.new{x=xx                                      , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[5] .. ".png", transparency=2, color_background=0xFF}
    p[10]=cpicture.new{x=xx+dxpic+dxtxt                         , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[5] .. ".png", transparency=2, color_background=0xFF}
    p[11]=cpicture.new{x=xx+breite+zwischenraum                 , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[6] .. ".png", transparency=2, color_background=0xFF}
    p[12]=cpicture.new{x=xx+breite+zwischenraum+dxpic+dxtxt     , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[6] .. ".png", transparency=2, color_background=0xFF}
    p[13]=cpicture.new{x=xx+2*(breite+zwischenraum)             , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[7] .. ".png", transparency=2, color_background=0xFF}
    p[14]=cpicture.new{x=xx+2*(breite+zwischenraum)+dxpic+dxtxt , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[7] .. ".png", transparency=2, color_background=0xFF}
    p[15]=cpicture.new{x=xx+3*(breite+zwischenraum)             , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idhome[8] .. ".png", transparency=2, color_background=0xFF}
    p[16]=cpicture.new{x=xx+3*(breite+zwischenraum)+dxpic+dxtxt , y=yy-60 , dx=dxpic, dy=dypic, image=logopfad[ligawahl + 2] .. idaway[8] .. ".png", transparency=2, color_background=0xFF}
    p[19]=cpicture.new{x=xx+4*(breite+zwischenraum)             , y=yy-50 , dx=20   , dy=20   , image="rot", transparency=2, color_background=0xFF, mode="ALIGN_CENTER"}
    p[20]=cpicture.new{x=xx+4*(breite+zwischenraum)+dxpic+dxtxt , y=yy-50 , dx=20   , dy=20   , image="gruen", transparency=2, color_background=0xFF, mode="ALIGN_CENTER"}
...
ta[162]=ctext.new{x=dx+250, y=y+550, dx=200, dy=20, text="zurÃ¼ck", color_body=0xFF, color_text=COL['WHITE'], font_text=FONT['MENU'], mode="ALIGN_LEFT" }
...
function font_groesse()
	if conf["font_size"] == "gross" then
		fontsize='MENU_TITLE'
	elseif conf["font_size"] == "normal" then
		fontsize='MENU'
	elseif conf["font_size"] == "klein" then
		fontsize='MENU_INFO'
	else
		fontsize='MENU'
	end
...
--Menue anzeigen
function addMenue()
	m = menu.new{name="Bundesliga Liveticker - Einstellungen", icon=bllogo, has_shadow=true}
	m:addItem{type = "back"}
